...
/**
 * An enumeration of isotopes, given by the corresponding element, their
 * atomicMass and natural abundance. The information if they are typically used
 * as tracers is included as well as the mass shift that will be induced if this
...
public enum Isotope implements Comparable<Isotope> {
	...
	/**
	 * An element is an tracer if it is used as tracer in isotope labeling
	 * experiments.
	 * 
	 * @return
	 */
	...
	/**
	 * 
	 * @return The mass shift value, induced by this isotope with respect to the m0
	 *         peak.
	 */
	 ...
	 * @return The Isotope that may induce exactly the given massShiftValue. A
	 *         massShiftValue == 0.0 will be induced by Isotope.NONE. A
	 *         massShiftValue that cannot be evaluated will return Isotope.UNDEFINED
	 */
	 ...
	 *         (an error lower than 0.0001 will be assumed to be okay). A
	 *         massShiftValue == 0.0 will be induced by Isotope.NONE. A
	 *         massShiftValue that cannot be evaluated will return Isotope.UNDEFINED
	 */
