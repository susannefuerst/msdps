...
/**
 * An extension of a MSDatabase where mass shifts and the isotopes that induced
 * the shifts are also included. See also: MassShiftDataSet.
 * 
 * @author sfuerst
 *
 */
public class MSShiftDatabase extends MSDatabase {
	 ...
	 * 0.8 | 43.9898 | 0.9876 | 0.0[0-0] | NONE | 44.9932 | 0.9966 | 0.0[0-0] | NONE
	 * | 43.9898 | 0.1975 | 0.0[0-0] | NONE | UNKNOWN | C | CO2 | 0.8 | 44.9932 |
	 * 0.0089 | 1.0034[0-1] | C_13 | NA | NA | NA | NA | 44.9932 | 0.799 |
	 * 1.0034[0-1] | C_13 | UNKNOWN | C | CO2 |
	 * 
	 ...
	 * 44.9932 | 0.0089 | 1.0034[0-1] | C_13 | NA | NA | NA | NA | 44.9932 | 0.799 |
	 * 1.0034[0-1] | C_13 | UNKNOWN | C | CO2 |
	 * 
	 * @param absoluteFilePath
	 */
	...
	public void parseCsv(String absoluteFilePath, SpectrumType spectrumType) {
		...
		try {
			...
			setFragmentKey(
					FragmentKey.byKeyName(records.get(1).get(MSShiftDatabaseColKey.FRAGMENT_KEY.getColumnIndex())));
			setIncorporatedTracers(records.get(1).get(MSShiftDatabaseColKey.INCORPORATED_TRACERS.getColumnIndex()));
			setFragmentFormula(records.get(1).get(MSShiftDatabaseColKey.FRAGMENT_FORMULA.getColumnIndex()));
	...
	/**
	 * write this object to csv using the headers defined in MSShiftDatabaseColKey
	 * enum. The csv will represent a table as follows:
	 * 
	 * IncRate | NaturalMass | NaturalFrequency | NaturalShiftValues |
	 * NaturalShiftIsotopes | MarkedMass | MarkedFrequency | MarkedShiftValues |
	 * MarkedShiftIsotopes | MixedMass | MixedFrequency | MixedShiftValues |
	...
	/**
	 * creates a string using {@link FragmentKey}, incorporated tracers and
	 * incorporation rate
	 */
	@Override
	...
	/**
	 * creates the MassShiftDataset members (natural, mixed and marked) from the
	 * MassSpectra members (natural, mixed and marked).
	 */
