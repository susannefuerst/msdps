...
public class MassShiftListTest extends TestCase {
	...
	public void testConstructor() {
		MassShiftList list = new MassShiftList(
				new MassShift(0, 0, 0.0),
				new MassShift(0, 1, 1.0033),
				new MassShift(1, 2, 2.0),
				new MassShift(2, 3, 0.9996));
	...
	public void testFromString() {
		MassShiftList expected = new MassShiftList(
				new MassShift(0, 0, 0.0),
				new MassShift(0, 1, 1.0033),
				new MassShift(1, 2, 2.0),
				new MassShift(2, 3, 0.9996));
	...
	public void testEqualsUpToPermutationOfIsotopes() {
		MassShiftList first = MassShiftList.fromString("2.0067[0-1]_1.0033[1-2]_1.0034[2-4]_0.9996[4-5]");
		MassShiftList second = MassShiftList.fromString("2.0067[0-1]_1.0033[1-2]_0.9996[2-3]_1.0034[3-5]");
